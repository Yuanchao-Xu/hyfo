...
data(tgridData)
# Since the example data, has some NA values, the process will include some warning     # message, which can be ignored in this case.
...
For time series bias correciton.
```{r}
...
```{r, fig.show='hide', fig.height=6, fig.width=9, results='hide', message=FALSE}
