...
You can go to [here](https://github.com/Yuanchao-Xu/hyfo/releases) to download different releases, and use IDE like Rstudio to install from file, both `tar.gz` and `zip` formats are provided.
