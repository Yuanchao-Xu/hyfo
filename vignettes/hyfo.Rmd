...
hyfo is designed for hydrology and climate forecasting anaylasis, containing a number of tools including data extration, data processing and data visulization. Official Website is [here](http://yuanchao-xu.github.io/hyfo/)
...
```
```{r, fig.show='hold', fig.height=8, fig.width=7}
...
```{r, fig.show='hold', fig.height=4, fig.width=9}
a1 <- getHisEnsem(a, example = c('1994-1-1', '1994-12-31'), output = 'ggplot', name = 1)
a2 <- getHisEnsem(a, example = c('1994-3-1', '1995-3-31'), output = 'ggplot', name = 2)
a3 <- getHisEnsem(a, example = c('1994-5-1', '1995-4-30'), output = 'ggplot', name = 3)
```
...
### 2.6.1 Get Ensemble Forecast from Forecasting Dataset (extracting members)
